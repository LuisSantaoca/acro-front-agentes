...
import LandingInstitucional from './pages/LandingInstitucional/ui/LandingInstitucional' // ← Importación añadida
...
export default function AppRouter() {
  return (
    <Router>
      <Routes>
        <Route path="/" element={<LandingInstitucional />} /> {/* ← Cambiado claramente al índice */}
        ...
        <Route path="/pruebas" element={<ProtectedLanding />} /> {/* ← Mantenemos ruta alternativa si es útil */}
